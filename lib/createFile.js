...
const nuxt = require('./create/nuxt')
...
exports.createProject = (answers, dirname) => {
  ...
  if(answers.scriptType === 'JavaScript'){
    ...
    nuxt.createSrc(answers, dirname)
  }
  ...
  // other
  copyFile(`${dirname}/project/.eslintignore`, `${answers.projectName}/.eslintignore`)
  copyFile(`${dirname}/project/.eslintrc.js`, `${answers.projectName}/.eslintrc.js`)
  copyFile(`${dirname}/project/.gitignore`, `${answers.projectName}/.gitignore`)
  ...
  execSh(`cd ${answers.projectName} && npm install`, (error, stdout, stderr) => {
    // spinner.stop()
